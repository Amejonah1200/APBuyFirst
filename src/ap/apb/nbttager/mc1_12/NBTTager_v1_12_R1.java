package ap.apb.nbttager.mc1_12;
...
public class NBTTager_v1_12_R1 implements NBTTager {
	...
	public ItemStack setNBTTag(String key, Object o, ItemStack is) {
		...
		ItemStack im = is;
		try {
			net.minecraft.server.v1_12_R1.ItemStack nms = org.bukkit.craftbukkit.v1_12_R1.inventory.CraftItemStack
					.asNMSCopy(im);
			net.minecraft.server.v1_12_R1.NBTTagCompound comp = nms.hasTag() ? nms.getTag()
					: new net.minecraft.server.v1_12_R1.NBTTagCompound();
			if (o instanceof net.minecraft.server.v1_12_R1.NBTBase) {
				comp.set(key, (net.minecraft.server.v1_12_R1.NBTBase) o);
			...
			nms.setTag(comp);
			is = org.bukkit.craftbukkit.v1_12_R1.inventory.CraftItemStack.asBukkitCopy(nms);
			return is;
		} catch (Exception e) {
			e.printStackTrace();
			return is2;
	...
	public Object getNBTTag(String key, ItemStack is) {
		try {
			net.minecraft.server.v1_12_R1.ItemStack nmsItem = org.bukkit.craftbukkit.v1_12_R1.inventory.CraftItemStack
					.asNMSCopy(is);
			net.minecraft.server.v1_12_R1.NBTTagCompound comp = (nmsItem.hasTag()) ? nmsItem.getTag()
					: new net.minecraft.server.v1_12_R1.NBTTagCompound();
			return comp.get(key);
		} catch (Exception e) {
			return null;
	...
	public ItemStack removeNBTTag(String key, ItemStack is) {
		...
		try {
			...
			comp.remove(key);
			nmsItem.setTag(comp);
			ItemMeta meta = org.bukkit.craftbukkit.v1_12_R1.inventory.CraftItemStack.getItemMeta(nmsItem);
			is.setItemMeta(meta);
			return is;
		} catch (Exception e) {
			return is2;
